    ...
    //* BNDDIR('YAJL') DECEDIT('0.')
      ...
      // Declaración del puntero que usará YAJL
        ...
        // Declaración del puntero que usará YAJL
          ...
          // dcl-s jsonGen int(10);
          // dcl-s errMsg varchar(500);
          // dcl-s HRequestId char(100);
          // dcl-s HChannel   char(20 );
          // dcl-s HSessionId char(100);
          // dcl-s HClientIp char(20);
          // dcl-s HUserId   char(20);
          // dcl-s HProvider char(20);
          // dcl-s HOrganization char(20);
          // dcl-s HTerminal char(20);
          // dcl-s HTimestamp char(50);
          // dcl-s ConfirmationNm char(11);
          // dcl-s RegionSd  char(15);
          // dcl-s BranchSd  char(15);
          // dcl-s StateCd   char(3);
          // dcl-s CountryCd char(3);
          // dcl-s Username  char(20);
          // dcl-s Terminal  char(15);
          // dcl-s AgentDt   char(8);
          // dcl-s AgentTm   char(6);
