...
El problema es que no se esta guardando el Log del SQL en el mismo archivo de LOG, se esta guardando dentro de la ruta bin de la carpeta del proyecto como sucedia antes, revisa bien por favor.
