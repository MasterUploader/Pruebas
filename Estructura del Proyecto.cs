Actualmente el proceso lee un archivo y realiza el debito y credito para las empresas, y tambien realiza el debito y credito por transacción de cliente, ahora en el archivo solo vendra las transacciones del cliente y la parte de debito y credito de empresa ira en un API, necesito que extraigas las parte correspondiente a empresas, sabiendo que lo que se recibe en el endpoint es:

{
  "numeroCuenta": "string",
  "montoDebitado": "string",
  ...
  "numeroDeCorte": "string",
  "idTransaccionUnico": "string",
  "estado": "string",
  "descripcionEstado": "string"
}


Y que el proceso que hacia en RPG, se hara ahora en C#, se debe extraer ahora el flujo solo para debito y credito.
Aplica al codigo C# las librerias RestUtilities.

    Te dejo el código RPG actual.
