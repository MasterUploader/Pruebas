...
using Microsoft.Owin.Security;                 // <-- Ticket, ISecureDataFormat, IAuthenticationManager
...
using Presentation.RestService.Results;
using System;
...
namespace Presentation.RestService.Controllers
{
    [Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        /// <summary>Resolve UserManager desde OWIN (vía HttpContext) para evitar conflictos con Request.GetOwinContext().</summary>
        public ApplicationUserManager UserManager
        {
            get
            {
                return _userManager ?? HttpContext.Current
                    .GetOwinContext()
        ...
        public async Task<IHttpActionResult> AddExternalLogin(AddExternalLoginBindingModel model)
        {
            ...
            if (ticket?.Identity == null ||
               (ticket.Properties?.ExpiresUtc.HasValue == true &&
        ...
        private IHttpActionResult GetErrorResult(IdentityResult result)
        {
            ...
            if (!result.Succeeded)
            {
                ...
                if (ModelState.IsValid) return BadRequest(); // sin detalles
        ...
        private static class RandomOAuthStateGenerator
        {
            ...
            public static string Generate(int strengthInBits)
            {
                ...
                if (strengthInBits % bitsPerByte != 0)
                    throw new ArgumentException("strengthInBits debe ser divisible por 8.", nameof(strengthInBits));
